...
namespace MyFitnessApp.Data.Migrations
{
    ...
    [Migration("20210709154955_RemoveImageCategoryEquipmentAddFollowerPostCommentProfile")]
    partial class RemoveImageCategoryEquipmentAddFollowerPostCommentProfile
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.Food", b =>
                {
                    ...
                    b.Property<double>("CalciumInPercents")
                        .HasColumnType("float");

                    b.Property<double>("CarbohydratesInGrams")
                        .HasColumnType("float");

                    b.Property<double>("CholesterolInMg")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("FiberInGrams")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("IronInPercents")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("PotasiumInMg")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("SoduimInMg")
                        .HasColumnType("float");

                    b.Property<double>("SugarsInGrams")
                        .HasColumnType("float");

                    b.Property<double>("VitaminAInPercents")
                        .HasColumnType("float");

                    b.Property<double>("VitaminCInPercents")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.FoodDiary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.Profile", b =>
                {
                    ...
                    b.Property<int>("ActivityLevelName")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.TrainingDiary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.TrainingDiaryExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TrainingDiaryExercises");
                });
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.Meal", b =>
                {
                    b.HasOne("MyFitnessApp.Data.Models.FoodDiary", "FoodDiary")
                        .WithMany("Meals")
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.Profile", b =>
                {
                    b.HasOne("MyFitnessApp.Data.Models.ApplicationUser", "User")
                        .WithOne("Profile")
                        .HasForeignKey("MyFitnessApp.Data.Models.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.TrainingDiaryExercise", b =>
                {
                    b.HasOne("MyFitnessApp.Data.Models.Exercise", "Exercise")
                        .WithMany("TrainingDiaryExercises")
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyFitnessApp.Data.Models.TrainingDiary", "TrainingDiary")
                        .WithMany("TrainingDiaryExercises")
            ...
            modelBuilder.Entity("MyFitnessApp.Data.Models.Exercise", b =>
                {
                    b.Navigation("TrainingDiaryExercises");
                });
